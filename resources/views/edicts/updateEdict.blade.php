...
@section('title', 'Edite seu Edital')
                    ...
                    <div class="form-content">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" name="submission_start" id="submission_start" class="form-control" value="{{ date('Y-m-d', strtotime($edict->submission_start)) }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="submission_finish">Término da Submissão</label>
                                <input type="date" name="submission_finish" id="submission_finish" class="form-control" value="{{ date('Y-m-d', strtotime($edict->submission_finish)) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" name="rate_start" id="rate_start" class="form-control" value="{{ date('Y-m-d', strtotime($edict->rate_start)) }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="rate_finish">Término da Avaliação</label>
                                <input type="date" name="rate_finish" id="rate_finish" class="form-control" value="{{ date('Y-m-d', strtotime($edict->rate_finish)) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" name="execution_start" id="execution_start" class="form-control" value="{{ date('Y-m-d', strtotime($edict->execution_start)) }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="execution_finish">Término da Execução</label>
                                <input type="date" name="execution_finish" id="execution_finish" class="form-control" value="{{ date('Y-m-d', strtotime($edict->execution_finish)) }}">
                            </div>
                        </div>
