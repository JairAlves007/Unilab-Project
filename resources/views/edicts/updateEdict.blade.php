...
<div class="d-flex">
  ...
  <div class="form-create bg-white m-1">
    <div class="form-type-4">
      ...
      <h1 class="titulo">Edite Seu Edital</h1>
        ...
        <div id="form-area">
          <div class="form-content">
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="inputGroup-sizing-default">Arquivo do Edital</span>
                </div>
                <div class="custom-file">
                  <input type="file" name="archive"
                    class="custom-file-input {{ $errors->has('archive') ? 'is-invalid' : '' }}" id="archive"
                    style="z-index: 2 !important">
                  <label class="input-group-text mb-0 custom-file-label" for="archive" data-browse="&#128269">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
              id="description" rows="5">{{ $edict->description }}</textarea>
        ...
        <div class="form-content">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" name="submission_start" id="submission_start"
                ...
                value="{{ date('Y-m-d', strtotime($edict->submission_start)) }}">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" name="submission_finish" id="submission_finish"
                ...
                value="{{ date('Y-m-d', strtotime($edict->submission_finish)) }}">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" name="rate_start" id="rate_start"
                ...
                value="{{ date('Y-m-d', strtotime($edict->rate_start)) }}">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" name="rate_finish" id="rate_finish"
                ...
                value="{{ date('Y-m-d', strtotime($edict->rate_finish)) }}">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="date" name="execution_start" id="execution_start"
                ...
                value="{{ date('Y-m-d', strtotime($edict->execution_start)) }}">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" name="execution_finish" id="execution_finish"
                ...
                value="{{ date('Y-m-d', strtotime($edict->execution_finish)) }}">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <select class="form-control {{ $errors->has('categories_id') ? 'is-invalid' : '' }}" name="categories_id"
                id="category">
