...
@section('content')
    ...
    <div class="d-flex">
        ...
        <div class="content p-1">
                            ...
                            <div class="form-group mx-auto-12">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input {{ $errors->has('niveis') ? 'is-invalid' : '' }}"
                                        type="checkbox" name="niveis[]" value="bolsista" id="checkBolsista" @if ($user_checking->hasRole('gestor'))
                                    checked
                    @endif
                    >
            ...
            <div class="form-check">
                <input class="form-check-input {{ $errors->has('niveis') ? 'is-invalid' : '' }}" type="checkbox"
                    name="niveis[]" value="orientador" id="checkOrientador" @if ($user_checking->hasRole('orientador'))
                checked
                @endif
                >
