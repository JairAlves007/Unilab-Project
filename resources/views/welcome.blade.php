...
@section('content')
    ...
    <div class="row corpo content">

        <div class="col-lg-4 col-sm-6 card-gap">

            <img src="img/editais/4f57c794856f5d2c65555705c806ff1b.png" class="card-img-top" alt="besteira">
            <div class="card">
                <div class="card-body">
