...
class FormCreateEdictRequest extends FormRequest
{
  ...
  public function rules()
  {
    $rules = [
      ...
      'rate_start' => ['required', 'date', 'date_format:Y-m-d', 'after:yesterday', 'same:submission_start'],
      'rate_finish' => ['required', 'date', 'date_format:Y-m-d', 'same:submission_finish', 'after:rate_start'],
  ...
  public function messages()
  {
    return [
      ...
      'rate_start.same' => 'O período de avaliação tem que ser igual ao de submissão',
      'rate_finish.required' => 'Informe uma data do Encerramento de Avaliação',
      'rate_finish.same' => 'O período de avaliação tem que ser igual ao de submissão',
      ...
      'submission_finish.after' => 'A data de término do Período de Submissão deve ser maior que a de Início',
